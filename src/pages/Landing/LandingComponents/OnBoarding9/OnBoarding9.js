           ...
           <ScreenHeader progress={'100'}/>
            ...
            <div className='basic__information__review__container'>
                <header className='basic__information__review__header'>
                  ...
                  <img src={editIcon} className='edit__icon' alt='edit basic information'/>
                </header>
                <div className='information__container'>
                  <span className='information'>
                     <span className='information__title'><strong>Name:</strong></span>{` ${formData.firstName} ${formData.lastName}`}
                   </span>
                   <span className='information'>
                     <span className='information__title'>Date of birth:</span>{` ${formData.dob}`}
                   </span>
                   <span className='information'>
                     <span className='information__title'>Gender:</span>{`${formData.gender}`}
                   </span>
                   <span className='information'>
                     <span className='information__title'>Nationality:</span>{`${formData.nationality}`}
                   </span>
                   <span className='information'>
                     <span className='information__title'>Country of residence:</span>{`${formData.countryOfResidence}`}
                   </span>
                   <span className='information'>
                     <span className='information__title'>Contact Number:</span>{`${formData.number}`}
                   </span>
                   <span className='information'>
                     <span className='information__title'>Email:</span>{`${formData.email}`}
                   </span>
                </div>
            </div>
